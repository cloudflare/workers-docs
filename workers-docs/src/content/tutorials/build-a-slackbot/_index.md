...
![Create a Slack App](/tutorials/build-a-slackbot/media/create-a-slack-app.png)
...
![Slack Incoming Webhook](/tutorials/build-a-slackbot/media/slack-incoming-webhook.png)
...
![Create Slack Command](/tutorials/build-a-slackbot/media/create-slack-command.png)
...
![Create a GitHub Webhook](/tutorials/build-a-slackbot/media/new-github-webhook.png)
...
![Example Slack Message with GitHub Issue](/tutorials/build-a-slackbot/media/issue-slack-message.png)
...
![Example Webhook Message](/tutorials/build-a-slackbot/media/webhook_example.png)
...
![Verify Wrangler Installation](/tutorials/build-a-slackbot/media/publish.gif)
...
![Create New Issue](/tutorials/build-a-slackbot/media/create-new-issue.gif)
