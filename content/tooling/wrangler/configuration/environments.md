...
⚠️  If you do not add workers_dev, this command may act unexpectedly in v1.5.0. Please see [environments](/tooling/wrangler/configuration/environments) for more information.
✨  Built successfully, built project size is 523 bytes.
✨  Successfully published your script to https://my-worker.<your-subdomain>.workers.dev
```
